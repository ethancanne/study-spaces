...
const popupReducer = (state = { view: "", isShowing: false, payload: {} }, action) => {
    switch (action.type) {
        ...
        case popupConstants.SHOW_CREATE_MEETING_STUDY_GROUP_POPUP:
            return { ...state, view: views.Popup.StudyGroup.CreateMeeting, isShowing: true, payload: action.payload };
        ...
        case popupConstants.SHOW_VIEW_MEETINGS_STUDY_GROUP_POPUP:
            return { ...state, view: views.Popup.StudyGroup.ViewMeetings, isShowing: true, payload: action.payload };
